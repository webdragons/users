...
abstract class BaseManager extends Component implements ManagerInterface
{
     ...
     * @param string $codename the auth item name.
     * @return Item the auth item corresponding to the specified name. Null is returned if no such item.
     */
    abstract protected function getItem($codename);
     ...
     * @inheritdoc
     */
    public function createRole($codename)
    {
        $role = new Role();
     ...
     * @inheritdoc
     */
    public function createPermission($codename)
    {
